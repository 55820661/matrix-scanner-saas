...
AI_SAFE_CONTEXT_MAX_BYTES = int(os.environ.get("AI_SAFE_CONTEXT_MAX_BYTES", "65536"))
...
ADMIN_LIVE_AI_RATE_LIMIT_PER_HOUR = int(os.environ.get("ADMIN_LIVE_AI_RATE_LIMIT_PER_HOUR", "30"))
